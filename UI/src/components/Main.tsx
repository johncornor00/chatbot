...
const Main = () => {
  ...
  return (
    <div className="main">
      <div className="nav">
        <img className="youtube-logo" src={assets.youtube_icon} alt="youtube" />
        <div className="unique-dropdown" ref={dropdownRef}>
          ...
          {isDropdownOpen && (
            <div className="unique-dropdown-menu">
              ...
              <NavLink to="/dashboard" className="unique-dropdown-item" onClick={() => setDropdownOpen(false)}>
                <IoHome />
                <span className="label">Dashboard</span>
              </NavLink>
              <div onClick={logout} className="unique-dropdown-item unique-logout">
                <IoLogOut />
      ...
      <div className="main-container">
        {showResult ? (
          ...
          <>
            ...
            <div className="cards">
              {/* Add cards content here if needed */}
            </div>
          </>
        )}
